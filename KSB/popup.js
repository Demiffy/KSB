...
document.addEventListener("DOMContentLoaded", function() {
    ...
    rozvrh.addEventListener("click", function() {
      chrome.tabs.create({ url: "https://sis.ssakhk.cz/TimeTable/PersonalNew/11975" });
    });
  
    znamky.addEventListener("click", function() {
      chrome.tabs.create({ url: "https://sis.ssakhk.cz/Classification/StudentMark/11975" });
    });

    absence.addEventListener("click", function() {
        chrome.tabs.create({ url: "https://sis.ssakhk.cz/Absent/Student/11975" });
      });
